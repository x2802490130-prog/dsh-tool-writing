...
export class Library {
  ...
  async embedNovel(id, opts) {
    ...
    const backend = (this.embedOpts && this.embedOpts.config && this.embedOpts.config.embedBackend) || (this.embedOpts && this.embedOpts.embedBackend) || "deepseek";
    if (backend === "deepseek") {
      const ci = this._conceptIdx();
      if (!ci.engine) return { embedded: 0, chunks: 0, skipped: 0, failed: 0, error: "无可用语义后端" };
